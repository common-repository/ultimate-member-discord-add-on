...
<div class="notice notice-warning ets-notice">
  <p><i class='fas fa-info'></i> <?php esc_html_e( 'Drag and Drop the Discord Roles over to the Ultimate Member Roles', 'ultimate-member-discord-add-on' ); ?></p>
</div>

<div class="row-container">
  <div class="ets-column ultimate-discord-roles-col">
	<h2><?php esc_html_e( 'Discord Roles', 'ultimate-member-discord-add-on' ); ?></h2>
	<hr>
  ...
  <div class="ets-column">
	<h2><?php esc_html_e( 'Ultimate Member', 'ultimate-member-discord-add-on' ); ?></h2>
	<hr>
...
<form method="post" action="<?php echo esc_url( get_site_url() . '/wp-admin/admin-post.php' ); ?>">
 ...
 <input type="hidden" name="current_url" value="<?php echo esc_url( ultimatemember_discord_get_current_screen_url() ); ?>">   
  <table class="form-table" role="presentation">
	<tbody>
	  <tr>
		<th scope="row"><label for="ultimate-member-defaultRole"><?php esc_html_e( 'Default Role', 'ultimate-member-discord-add-on' ); ?></label></th>
		<td>
		  ...
		  <select id="ultimate-member-defaultRole" name="ultimate-member_defaultRole">
			<option value="none"><?php esc_html_e( '-None-', 'ultimate-member-discord-add-on' ); ?></option>
		  </select>
		  <p class="description"><?php esc_html_e( 'This Role will be assigned to all roles members', 'ultimate-member-discord-add-on' ); ?></p>
		</td>
	  </tr>
  ...
  <div class="bottom-btn">
	...
	<button id="revertMapping" name="flush" class="ets-submit ets-btn-submit ets-bg-red">
	  <?php esc_html_e( 'Flush Mappings', 'ultimate-member-discord-add-on' ); ?>
	</button>
  </div>
</form>
